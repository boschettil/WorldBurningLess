WorldBurningLessFigures.R <- function(zone = 1, crop = 1, fig = 1, start.month = 3, col = "red")
{

  library(rlang)
  #
  # Code to generated Figure 1a and Figure 2 
  #
  #to plot figure 1a
  # WorldBurningLessFigures.R(zone = 15, fig = 1)
  #
  # to plot figure 2
  # sort zones from largest to smallest average annual area burned
  # > zones <- c(12, 2, 6, 3, 4, 9, 14, 13, 11, 8, 10, 5, 7, 1)
  # par(mfrow=c(5,3))
